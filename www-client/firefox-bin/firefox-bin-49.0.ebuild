...
MOZ_LANGS=( en-US ja )
# ach af an ar as ast az be bg bn-BD bn-IN br bs ca cs cy da de
...
MOZ_PV="${MOZ_PV/-candidates/candidates}" # Handle candidates for SRC_URI
MOZ_PN="${PN/-bin}"
MOZ_P="${MOZ_PN}-${MOZ_PV}"

# MOZ_HTTP_URI="http://archive.mozilla.org/pub/mozilla.org/${MOZ_PN}/releases/"
MOZ_HTTP_URI="http://ftp.mozilla.org/pub/${MOZ_PN}/candidates/"

inherit eutils multilib pax-utils fdo-mime gnome2-utils mozlinguas-v2 nsplugins

DESCRIPTION="Firefox Web Browser"
SRC_URI="${SRC_URI}
	amd64? ( ${MOZ_HTTP_URI%/}/${MOZ_PV}-candidates/build3/linux-x86_64-EME-free/ja/${MOZ_P}.tar.bz2 -> ${PN}_x86_64-${PV}.tar.bz2 )"
# 	x86? ( ${MOZ_HTTP_URI%/}/${MOZ_PV}-candidates/build3/linux-i686-EME-free/ja/${MOZ_P}.tar.bz2 -> ${PN}_i686-${PV}.tar.bz2 )"
